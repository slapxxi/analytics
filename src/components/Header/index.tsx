...
export const Header = () => {
  return (
    <header className="col-[wide] grid grid-cols-subgrid bg-blue-950 text-base text-slatey-400 shadow md:shadow-none">
      <div className="col-[main] grid grid-cols-[1fr_auto] md:grid-cols-[1fr_3fr_1fr] items-center gap-4.5 py-5">
        <Logo className="w-32" />
